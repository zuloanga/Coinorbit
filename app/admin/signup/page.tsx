...
import { adminSignUp } from "@/lib/auth-service"
      ...
      <div className="relative z-20 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col items-center">
            <Shield className="w-12 h-12 text-blue-400 [filter:drop-shadow(0_0_8px_rgb(96,165,250))]" />
            <h2 className="mt-6 text-center text-3xl font-bold text-white">Create Admin Account</h2>
